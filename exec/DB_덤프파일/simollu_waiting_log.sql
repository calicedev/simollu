...
CREATE TABLE `waiting_log` (
  `waiting_log_seq` bigint NOT NULL AUTO_INCREMENT,
  `restaurant_seq` bigint NOT NULL,
  `waiting_log_rank` int DEFAULT NULL,
  `waiting_log_time` bigint NOT NULL,
  `waiting_person_cnt` int NOT NULL,
  `waiting_status_entrance_date` datetime(6) DEFAULT NULL,
  `waiting_status_regist_date` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`waiting_log_seq`)
